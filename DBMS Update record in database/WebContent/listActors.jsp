			...
			<table border="1">
				...
				<%
					...
					for (int i = 0; i < listActors.size(); i++) {
						...
						String updateURL = request.getContextPath()+"/operation?page=updateActors"+
											"&actorId="+listActors.get(i).getActor_id()+
											"&firstname="+listActors.get(i).getFirst_name()+
											"&lastname="+listActors.get(i).getLast_name();
