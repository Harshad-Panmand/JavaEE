    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse navbar-right">
        <ul class="nav navbar-nav">
          ...
          <li><a href="${pageContext.request.contextPath}/operation?page=listActors">List Actors</a></li>
          <li><a href="${pageContext.request.contextPath}/operation?page=addActors">Add Actors</a></li>
        </ul>
      </div>
      <!--/.nav-collapse -->
    </div>
